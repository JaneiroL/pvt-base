...
def get_min_sl_pips_from_vola_by_mode(
    ...
    """
    MIN-SL in Pips aus Daily-Vola – adaptiv je Mode.

    - vola_days_by_mode: Mode -> Dezimalzahl (0.1 Steps), 0.0 => deaktiviert -> Fallback MIN_SL_PIPS
    - apply_factor_by_mode: Mode -> bool (ob Multiplikator aus factors[pair] angewendet wird)
    """
...
def main() -> None:
    ...
    # ✅ NEU: Faktor-Toggle pro Mode (Enter=ja, n=nein)
