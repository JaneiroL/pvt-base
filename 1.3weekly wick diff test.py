...
# Sonder-Fixes für kaputte Codes aus alten Dateien
SPECIAL_PAIR_FIX = {
    "OANDAG": "GBPNZD",   # Dein spezieller Bug
}
...
def load_pivots(path: Path, tf_tag: str) -> pd.DataFrame:
    ...
    # Pair-Code robust aus 'pair' ziehen
...
def run_mode(
    ...
    for _, row in pivots.iterrows():
        # hier zusätzlich über SPECIAL_PAIR_FIX laufen
